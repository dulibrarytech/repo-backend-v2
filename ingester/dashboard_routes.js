...
module.exports = function mount(app) {
    ...
    /*
     * Static Workflow Guide (Help). Read-only; literal path registered with the
     * other page routes, before the `:id/*` row routes below.
     */
    app.get(`${base}/help`, require_dashboard_auth, controller.help_page);
    ...
    app.post(
        ...
        can_ingest,
        write_limiter(),
        controller.rollback_batch_pre_action
    );
    app.post(
        `${base}/:id/rollback-am`,
        require_dashboard_auth,
